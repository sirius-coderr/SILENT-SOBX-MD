...
const sessdata = config.SESSION_ID.replace("SILENT-SOBX-MD~", '');
...
console.log("SESSION DOWNLOADED SUCCESSFULLY ✅")
  ...
  console.log("SILENT-SOBX-MD CONNECTING TO WHATSAPP PLZ WAIT..⏳️");
  ...
  console.log('SILENT-SOBX-MD CONNECTED SUCCESSFULLY ✅')
...
conn.downloadAndSaveMediaMessage = async (message, filename, appendExtension = true) => {
  ...
  app.get("/", (req, res) => {
  res.send("SILENT-SOBX-MD STARTED ✅");
  });
